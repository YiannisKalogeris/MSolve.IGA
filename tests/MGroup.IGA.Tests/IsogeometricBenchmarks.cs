...
namespace MGroup.IGA.Tests
{
	...
	public class IsogeometricBenchmarks
	{
		...
		public void IsogeometricQuadraticCantilever2D()
		{
			...
			string filename = "..\\..\\..\\MGroup.IGA.Tests\\InputFiles\\Cantilever2D.txt";
		...
		public void IsogeometricPlateTension()
		{
			...
			Model model = new Model();
			ModelCreator modelCreator = new ModelCreator(model);
			string filename = "..\\..\\..\\MGroup.IGA.Tests\\InputFiles\\PlateTension.txt";
			IsogeometricReader modelReader = new IsogeometricReader(modelCreator, filename);
			modelReader.CreateModelFromFile();
			...
			#endregion expectedDisplacement
		}
		...
		public void IsogeometricPlaneStrainMixedBC()
		{
			...
			Model model = new Model();
			ModelCreator modelCreator = new ModelCreator(model);
			string filename = "..\\..\\..\\MGroup.IGA.Tests\\InputFiles\\SquareMixedBC.txt";
			IsogeometricReader modelReader = new IsogeometricReader(modelCreator, filename);
			modelReader.CreateModelFromFile();
		...
		public void TSplinesShellsBenchmark()
		{
			...
			for (int i = 0; i < model.ControlPointsDictionary.Count - 100; i++)
			{
				model.Loads.Add(new Load()
				{
					Amount = -1000,
