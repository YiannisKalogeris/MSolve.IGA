namespace MGroup.IGA.Postprocessing
{
    ...
    /// <summary>
    /// Paraview file  generator for 2D T-Spline geometries.
    /// </summary>
    public class ParaviewTsplines2D
    {
        private readonly Model _model;
        private readonly ILinearSystem _linearSystem;
        ...
        /// <summary>
        /// Creates Paraview File of the 2D T-Spline geometry.
        /// </summary>
        ...
        private void Write2DTSplinesFile(double[,] nodeCoordinates, int[,] elementConnectivity, double[,] displacements)
        {
